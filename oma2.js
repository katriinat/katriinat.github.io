...
function kerro(data){
    ...
    teksti = teksti + "<p>Toteutuksen ajankohta: " + data.alkupvm + "-" + data.loppupvm + "</br>";
    teksti = teksti + "Toteutuksen kesto: " + data.kesto + " viikkoa" + "</br>";
    teksti = teksti + "Osallistujien lukumäärä: " + data.osallistujat_lkm + "</p>";
